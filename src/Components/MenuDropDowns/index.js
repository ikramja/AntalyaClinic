import "./index.css";
import { Affix, Collapse, theme } from "antd";
						...
						>
							...
							<Panel header="БЛОГ" key="5" style={panelStyle}>
								...
								<Link
									...
									className="link-drop-down-menu-mobile"
								>
									<h2 style={{ fontSize: "0.9rem" }}>Статьи</h2>
								</Link>
							</Panel>
							<Panel header="СЕРВИС" key="6" style={panelStyle}>
								<Link
									...
									className="link-drop-down-menu-mobile"
								>
									<h2 style={{ marginBottom: "2rem", fontSize: "0.9rem" }}>
										Трансфер
									</h2>
								</Link>
								<Link
								...
								<Link
									...
									className="link-drop-down-menu-mobile"
								>
									<h2 style={{ fontSize: "0.9rem" }}>Переводчик</h2>
								</Link>
							</Panel>
							<Panel header="ДЛЯ ПАЦИЕНТОВ" key="7" style={panelStyle}>
								<Link
									...
									className="link-drop-down-menu-mobile"
								>
									<h2 style={{ fontSize: "0.9rem" }}>Памятки пациентам</h2>
								</Link>
							</Panel>
						</Collapse>
					</Panel>

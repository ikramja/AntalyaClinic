					...
					<FadeInUpAnimation
						...
						elements={[
							<p className="under-big-image-container-paragraph">
								...
								гостям получить комплексную эффективную диагностику,
								преображение и лечение. Команда врачей нашей клиники -
								профессионалы высокого класса, имеющие признанною сертификацию.
							</p>,
						]}
					/>
				</Container>

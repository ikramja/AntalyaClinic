    ...
    return (
        <div>
            ...
            <Row className='container py-5' align='middle'>
                <Col sm={24} md={8}>
                    <h1>Телефон:</h1>
                    <h4>+7 (495) 181-10-83</h4>
                    <a href='mailto:info@elarte.clinic'>
                        <h5>info@elarte.clinic</h5>
                    </a>

                    <h1 className='mt-4'>График работы:</h1>
                ...
                <Col sm={24} md={16}>
                    ...
                    <h3 className='mt-4 text-start'>
                        Mehmetçik Mah. Termesos Bulvarı Çınar Sitesi B blok No 16/B D28Muratpaşa, Antalya
                    </h3>
                </Col>
            </Row>
        </div>

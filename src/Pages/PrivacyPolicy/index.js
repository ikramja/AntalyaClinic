			...
			<Fade bottom>
				<div className="privacy-policy mx-5">
					<p>
						...
						Пользовательского соглашения, размещенного на сайте в сети Интернет
						по адресу: https://elarteclinic.com/user-agreement (далее - Сайт).
					</p>
					<p>
					...
					<p>
						2.2.7. Осуществление рекламных рассылок с согласия Пользователя.
					</p>
					...
					<p>
						7.4. Действующая Политика конфиденциальности размещена на странице
						по адресу: https://elarteclinic.com/privacy
					</p>
					<p>
